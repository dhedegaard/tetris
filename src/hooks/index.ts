...
import { Coordinate } from '../components/ShapeDrawer'
import {
...
const useTetris = () => {
  ...
  const [blocks, setBlocks] = useState<Set<Coordinate>>(new Set())
  ...
  useInterval(() => {
    setPosition(oldPosition => {
      ...
      if (newPositions.find(e => e.y >= 20 || blocks.has(e)) != null) {
